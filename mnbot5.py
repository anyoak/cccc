    ...
    def create_tables(self):
        ...
        c.execute('''CREATE TABLE IF NOT EXISTS users
                    (user_id INTEGER PRIMARY KEY, 
                     ...
                     total_otp_received INTEGER DEFAULT 0)''')
...
def show_admin_panel(chat_id):
    try:
        ...
        bot.send_message(chat_id, "❌ Error loading admin panel")
...
if __name__ == "__main__":
    ...
    print("✅ All admin panel functions are working:")
    print("   1. ✅ Admin Panel with all options")
    print("   2. ✅ Status Dashboard")
    print("   3. ✅ Settings Management")
    print("   4. ✅ Broadcast System")
    print("   5. ✅ User Management")
    print("   6. ✅ Number Management")
    print("   7. ✅ Withdrawal Management")
    print("   8. ✅ Support Ticket System")
    print("   9. ✅ Stats Export")
    print("   10. ✅ Reset System")
    print("   11. ✅ Numbers Report")
    print("   12. ✅ Revenue only for OTP messages")
    print("   13. ✅ Reset button in main menu")
    print("   14. ✅ Accurate balance tracking")
